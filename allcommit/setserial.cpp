...
//            this, &SetSerial::apply);
    ...
    connect(ui->serialPortInfoListBox, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SetSerial::showPortInfo);
    connect(ui->baudRateBox,  static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SetSerial::checkCustomBaudRatePolicy);
    connect(ui->serialPortInfoListBox,  static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SetSerial::checkCustomDevicePathPolicy);
...
SetSerial::Settings SetSerial::settings() const
{
    return currentSettings;
}

void SetSerial::showPortInfo(int idx)
{
    if (idx == -1)
        return;
...
void SetSerial::apply()
{
    updateSettings();
    hide();
}

void SetSerial::checkCustomBaudRatePolicy(int idx)
{
...
void SetSerial::checkCustomDevicePathPolicy(int idx)
{
...
void SetSerial::fillPortsParameters()
{
